...
public class Fournisseurs extends javax.swing.JFrame {
    ...
    public void table() {
        ...
        rs = db.querySelect(colon, "fournisseurs");
    ...
    private void initComponents() {
        ...
        jPanel2.add(txtrech);
        txtrech.setBounds(400, 70, 180, 30);
        ...
        jButton5.setBounds(220, 70, 128, 30);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (txtrech.getText().equals("")) {
            ...
            if (comrech.getSelectedItem().equals("Code")) {
                String colon[] = {"Code","Nom","Fournisseur","Description","Type","Couleur","Finition","Prix","Stock"};
                rs = db.fcSelectCommand(colon, "fournisseurs", "Code LIKE '" + txtrech.getText() + "' ");
                tbl_four.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("Nom")) {
                String colon[] = {"Code","Nom","Fournisseur","Description","Type","Couleur","Finition","Prix","Stock"};
                rs = db.fcSelectCommand(colon, "fournisseurs", "Nom LIKE '" + txtrech.getText() + "' ");
                tbl_four.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("Fournisseur")) {
                String colon[] = {"Code","Nom","Fournisseur","Description","Type","Couleur","Finition","Prix","Stock"};
                rs = db.fcSelectCommand(colon, "fournisseurs", "Fournisseur LIKE '" + txtrech.getText() + "' ");
                tbl_four.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("Description")) {
                String colon[] = {"Code","Nom","Fournisseur","Description","Type","Couleur","Finition","Prix","Stock"};
                rs = db.fcSelectCommand(colon, "fournisseurs", "Description LIKE '" + txtrech.getText() + "' ");
                tbl_four.setModel(new ResultSetTableModel(rs));
                } else if (comrech.getSelectedItem().equals("Type")) {
                String colon[] = {"Code","Nom","Fournisseur","Description","Type","Couleur","Finition","Prix","Stock"};
                rs = db.fcSelectCommand(colon, "fournisseurs", "Type LIKE '" + txtrech.getText() + "' ");
                tbl_four.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("Couleur")) {
                String colon[] = {"Code","Nom","Fournisseur","Description","Type","Couleur","Finition","Prix","Stock"};
                rs = db.fcSelectCommand(colon, "fournisseurs", "Couleur LIKE '" + txtrech.getText() + "' ");
                tbl_four.setModel(new ResultSetTableModel(rs));
                } else if (comrech.getSelectedItem().equals("Finition")) {
                String colon[] = {"Code","Nom","Fournisseur","Description","Type","Couleur","Finition","Prix","Stock"};
                rs = db.fcSelectCommand(colon, "fournisseurs", "Finition LIKE '" + txtrech.getText() + "' ");
                tbl_four.setModel(new ResultSetTableModel(rs));
            } else if (comrech.getSelectedItem().equals("Prix")) {
                String colon[] = {"Code","Nom","Fournisseur","Description","Type","Couleur","Finition","Prix","Stock"};
                rs = db.fcSelectCommand(colon, "fournisseurs", "Prix LIKE '" + txtrech.getText() + "' ");
                tbl_four.setModel(new ResultSetTableModel(rs));
                } else if (comrech.getSelectedItem().equals("Stock")) {
                String colon[] = {"Code","Nom","Fournisseur","Description","Type","Couleur","Finition","Prix","Stock"};
                rs = db.fcSelectCommand(colon, "fournisseurs", "Stock LIKE '" + txtrech.getText() + "' ");
                tbl_four.setModel(new ResultSetTableModel(rs));
...
this.dispose();
    ...
    public void subtotal() {
       ...
       public boolean test_stock() throws SQLException {
        boolean teststock;
        rs = db.querySelectAll("fournisseurs","Code='" + txtcode.getText() + "'");
        while (rs.next()) {
            old = rs.getInt("Stock");
        }
    ...
    public void def() throws SQLException {
        ...
        String[] colon = {"Stock"};
        String[] isi = {a};
        System.out.println(db.queryUpdate("fournisseurs", colon, isi, "Code='" + txtcode.getText() + "'"));
    }
